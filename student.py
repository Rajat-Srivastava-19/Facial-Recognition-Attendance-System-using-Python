...
class Student:
    ...
    #====================variables=====================
        ...
        title_lbl=Label(bg_img,text="STUDENT ACCOUNT MANAGER",font=("Arial",35,"bold"),bg="white",fg="Blue")
        ...
        #left label frame
        left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Account",font=("times new roman",12,"bold"))
        left_frame.place(x=10,y=10,width=730,height=580)
        
        
        img_left=Image.open(r"C:\Users\sriva\OneDrive\Desktop\Face Recognition System\Images\FC.png")
        ...
        #current course
        current_frame=LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Course Details",font=("times new roman",12,"bold"))
        current_frame.place(x=5,y=135,width=720,height=150)
        
        #department informatoion
        ...
        dep_combo["values"]=("Department Name","CSE","IT","ECE","EEE","ME","CIVIL","CE","BSH","Business","marketing","Finance")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=1,padx=2,pady=10,sticky=W)
        
        #Course Information
        course_label=Label(current_frame,text="Course Information",font=("times new roman",12,"bold"),bg="white")
        ...
        course_combo["values"]=("Course Name","B.Tech","BE","BCA","BBA","M.Tech","MBA","MCA","BSC","MSC","B.Voc")
        course_combo.current(0)
        course_combo.grid(row=0,column=3,padx=2,pady=10,sticky=W)
        
        
        #Year Information
        year_label=Label(current_frame,text="Year Information",font=("times new roman",12,"bold"),bg="white")
        ...
        year_combo["values"]=("Choose Year","1st","2nd","3rd","4th")
        year_combo.current(0)
        year_combo.grid(row=1,column=1,padx=2,pady=10,sticky=W)
        
        
        #Semester Details
        sem_label=Label(current_frame,text="Semester Details",font=("times new roman",12,"bold"),bg="white")
        ...
        sem_combo["values"]=("Choose Semester","1","2","3","4","5","6","7","8")
        sem_combo.current(0)
        sem_combo.grid(row=1,column=3,padx=2,pady=10,sticky=W)
        
        
        #class student frame
        class_student_frame=LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Student Class Details",font=("times new roman",12,"bold"))
        ...
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=17,font=("times new roman",13,"bold"),bg="yellow",fg="white")
        ...
        #right label frame
        right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Account",font=("times new roman",12,"bold"))
        right_frame.place(x=750,y=10,width=720,height=580)
        
        
        img_right=Image.open(r"C:\Users\sriva\OneDrive\Desktop\Face Recognition System\Images\gettyimages-1151406331-612x612.jpg")
        ...
        search_combo["values"]=("Select","Roll No","Phone No","Name","Student Id","Email")
        ...
        search_btn=Button(Search_frame,text="Search",width=14,font=("times new roman",12,"bold"),bg="black",fg="white")
    ...
    def add_data(self):
        if self.var_dep.get()=="Department Name" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            messagebox.showerror("Error","All Fields are required",parent=self.root)
        else:
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Raj@m123",database="face_recognition")
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success","Details have been Successfully registered.",parent=self.root)
    ...
    #==========================RESET FUNCTION======================================
    def reset_data(self):
        self.var_dep.set("Department Name")
        self.var_course.set("Course Name")
        self.var_year.set("Choose Year")
        self.var_semester.set("Choose Semester")
        self.var_std_id.set("")
