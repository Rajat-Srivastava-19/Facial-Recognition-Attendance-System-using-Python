...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="FACE RECOGNITION",font=("Arial",35,"bold"),bg="white",fg="purple")
        title_lbl.place(x=0,y=0,width=1530,height=45)
        
        #1st Image
        img_top=Image.open(r"Images\FC.png")
        ...
        #2nd Image
        img_bottom=Image.open(r"Images\img3.jpeg")
        ...
        #button
        b1_1=Button(f_lbl,text="Recognize Face",command=self.face_recog,cursor="hand2",font=("Arial",15,"bold"),bg="purple",fg="white")
