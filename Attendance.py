...
class Attendance:
    def __init__(self,root):
        ...
        #First Image
        img=Image.open(r"Images\FC.png")
        ...
        #Second Image
        img1=Image.open(r"Images\FC.png")
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGER",font=("Arial",35,"bold"),bg="white",fg="Blue")
        ...
        left_inside_frame.place(x=0,y=55,width=720,height=300)
        ...
        import_btn=Button(btn_frame,text="Import csv",command=self.importcsv,width=17,font=("times new roman",13,"bold"),bg="green",fg="white")
        import_btn.grid(row=0,column=0)
        
        export_btn=Button(btn_frame,text="Export csv",command=self.exportcsv,width=17,font=("times new roman",13,"bold"),bg="yellow",fg="black")
        export_btn.grid(row=0,column=1)
        
        delete_btn=Button(btn_frame,text="Update",width=17,font=("times new roman",13,"bold"),bg="red",fg="white")
    ...
    def exportcsv(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.showinfo("Data Export","Your data has been successfully exported.")
